    ...
    <div 
      ...
      className={`flex flex-col rounded-lg bg-[#070707] border border-white/10 shadow-2xl overflow-hidden transition-all ${
        isFullscreen 
          ...
          : 'h-[540px] sm:h-[620px] md:h-[700px] lg:h-[760px]'
      }`}
    >
      {/* Top Browser Chrome Bar */}
      <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-2.5 bg-[#0e0e0e] border-b border-white/10 shrink-0">
        ...
        <div className="flex items-center space-x-1.5 sm:space-x-2 shrink-0 ml-auto sm:ml-0">
          ...
          {htmlFile && (
            <button
              ...
              className={`p-1 sm:p-1.5 rounded border text-xs font-mono transition-colors ${
                showHtmlSource 
          ...
          <button
            ...
            className="p-1 sm:p-1.5 rounded bg-white/5 hover:bg-white/10 border border-white/10 text-white/70 hover:text-white transition-colors"
          >
      ...
      <div className="flex-1 bg-[#050505] p-2 sm:p-4 flex items-center justify-center overflow-hidden relative">
        {showHtmlSource && htmlFile ? (
          <div className="w-full h-full p-3 sm:p-4 rounded bg-[#0a0a0a] border border-white/10 overflow-auto font-mono text-xs text-white/80">
            ...
            <pre className="whitespace-pre-wrap font-mono text-xs leading-relaxed">{htmlFile.content}</pre>
          </div>
        ) : isReady ? (
          <div 
          ...
          <div className="max-w-md p-4 sm:p-6 rounded-lg bg-[#0a0a0a] border border-white/10 text-center space-y-4 mx-2">
            ...
            <div className="space-y-1.5">
              <h3 className="text-xs sm:text-sm font-mono font-bold text-white">
            ...
            <div className="p-2.5 sm:p-3 rounded bg-black/50 border border-white/5 text-[10px] sm:text-[11px] font-mono text-left space-y-1">
              <div className="flex justify-between text-white/40">
                ...
                <span className="text-white/70 truncate max-w-[160px] sm:max-w-[200px]">{project.originalUserPrompt}</span>
              </div>
              <div className="flex justify-between text-white/40">
